...
namespace MyEngine {
    ...
    public:
         ...
         * @param _method 请求方法
         */
        void setMethod(HttpMethod _method) { this->method = _method; }
        /**
         * 获取 Url
         * @return Url
         */
         ...
         * @param _url 设置 Url
         */
        void setUrl(const string &_url) { this->url = _url; }
        /**
         * 获取查询字符串
         * @return 查询字符串
         */
        string getQueryString() const { return this->query_string; }
        /**
         * 设置查询字符串
         * @param queryString 查询字符串
         */
        void setQueryString(const string &queryString) { this->query_string = queryString; }
